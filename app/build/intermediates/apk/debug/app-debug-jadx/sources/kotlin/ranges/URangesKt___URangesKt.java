...
class URangesKt___URangesKt {
    public static final int first(UIntProgression $this$first) {
        ...
        return $this$first.m1273getFirstpVg5ArA();
    }
    ...
    public static final long first(ULongProgression $this$first) {
        ...
        return $this$first.m1280getFirstsVKNKU();
    }
    ...
    public static final UInt firstOrNull(UIntProgression $this$firstOrNull) {
        ...
        return UInt.m132boximpl($this$firstOrNull.m1273getFirstpVg5ArA());
    }
    ...
    public static final ULong firstOrNull(ULongProgression $this$firstOrNull) {
        ...
        return ULong.m210boximpl($this$firstOrNull.m1280getFirstsVKNKU());
    }
    ...
    public static final int last(UIntProgression $this$last) {
        ...
        return $this$last.m1274getLastpVg5ArA();
    }
    ...
    public static final long last(ULongProgression $this$last) {
        ...
        return $this$last.m1281getLastsVKNKU();
    }
    ...
    public static final UInt lastOrNull(UIntProgression $this$lastOrNull) {
        ...
        return UInt.m132boximpl($this$lastOrNull.m1274getLastpVg5ArA());
    }
    ...
    public static final ULong lastOrNull(ULongProgression $this$lastOrNull) {
        ...
        return ULong.m210boximpl($this$lastOrNull.m1281getLastsVKNKU());
    }
    ...
    private static final boolean m1306containsbiwQdVI(UIntRange contains, UInt element) {
        ...
        return element != null && contains.m1277containsWZ4Q5Ns(element.m189unboximpl());
    }

    /* renamed from: contains-GYNo2lE  reason: not valid java name */
    private static final boolean m1302containsGYNo2lE(ULongRange contains, ULong element) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return element != null && contains.m1284containsVKZWuLQ(element.m267unboximpl());
    }
    ...
    public static final boolean m1308containsuhHAxoY(ULongRange contains, short value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1284containsVKZWuLQ(ULong.m216constructorimpl(value & 65535));
    }

    /* renamed from: downTo-Kr8caGY  reason: not valid java name */
    public static final UIntProgression m1311downToKr8caGY(byte $this$downTo_u2dKr8caGY, byte to) {
        return UIntProgression.Companion.m1275fromClosedRangeNkh28Cs(UInt.m138constructorimpl($this$downTo_u2dKr8caGY & UByte.MAX_VALUE), UInt.m138constructorimpl(to & UByte.MAX_VALUE), -1);
    }

    /* renamed from: downTo-J1ME1BU  reason: not valid java name */
    public static final UIntProgression m1310downToJ1ME1BU(int $this$downTo_u2dJ1ME1BU, int to) {
        return UIntProgression.Companion.m1275fromClosedRangeNkh28Cs($this$downTo_u2dJ1ME1BU, to, -1);
    }

    /* renamed from: downTo-eb3DHEI  reason: not valid java name */
    public static final ULongProgression m1312downToeb3DHEI(long $this$downTo_u2deb3DHEI, long to) {
        return ULongProgression.Companion.m1282fromClosedRange7ftBX0g($this$downTo_u2deb3DHEI, to, -1L);
    }

    /* renamed from: downTo-5PvTz6A  reason: not valid java name */
    public static final UIntProgression m1309downTo5PvTz6A(short $this$downTo_u2d5PvTz6A, short to) {
        return UIntProgression.Companion.m1275fromClosedRangeNkh28Cs(UInt.m138constructorimpl($this$downTo_u2d5PvTz6A & UShort.MAX_VALUE), UInt.m138constructorimpl(65535 & to), -1);
    }

    public static final UIntProgression reversed(UIntProgression $this$reversed) {
        Intrinsics.checkNotNullParameter($this$reversed, "<this>");
        return UIntProgression.Companion.m1275fromClosedRangeNkh28Cs($this$reversed.m1274getLastpVg5ArA(), $this$reversed.m1273getFirstpVg5ArA(), -$this$reversed.getStep());
    }

    public static final ULongProgression reversed(ULongProgression $this$reversed) {
        Intrinsics.checkNotNullParameter($this$reversed, "<this>");
        return ULongProgression.Companion.m1282fromClosedRange7ftBX0g($this$reversed.m1281getLastsVKNKU(), $this$reversed.m1280getFirstsVKNKU(), -$this$reversed.getStep());
    }
    ...
    public static final UIntProgression step(UIntProgression $this$step, int step) {
        ...
        return UIntProgression.Companion.m1275fromClosedRangeNkh28Cs($this$step.m1273getFirstpVg5ArA(), $this$step.m1274getLastpVg5ArA(), $this$step.getStep() > 0 ? step : -step);
    }
    ...
    public static final ULongProgression step(ULongProgression $this$step, long step) {
        ...
        return ULongProgression.Companion.m1282fromClosedRange7ftBX0g($this$step.m1280getFirstsVKNKU(), $this$step.m1281getLastsVKNKU(), $this$step.getStep() > 0 ? step : -step);
    }

    /* renamed from: until-Kr8caGY  reason: not valid java name */
    public static final UIntRange m1315untilKr8caGY(byte $this$until_u2dKr8caGY, byte to) {
        return Intrinsics.compare(to & UByte.MAX_VALUE, 0) <= 0 ? UIntRange.Companion.getEMPTY() : new UIntRange(UInt.m138constructorimpl($this$until_u2dKr8caGY & UByte.MAX_VALUE), UInt.m138constructorimpl(UInt.m138constructorimpl(to & UByte.MAX_VALUE) - 1), null);
    }

    /* renamed from: until-J1ME1BU  reason: not valid java name */
    public static final UIntRange m1314untilJ1ME1BU(int $this$until_u2dJ1ME1BU, int to) {
        return UnsignedKt.uintCompare(to, 0) <= 0 ? UIntRange.Companion.getEMPTY() : new UIntRange($this$until_u2dJ1ME1BU, UInt.m138constructorimpl(to - 1), null);
    }

    /* renamed from: until-eb3DHEI  reason: not valid java name */
    public static final ULongRange m1316untileb3DHEI(long $this$until_u2deb3DHEI, long to) {
        return UnsignedKt.ulongCompare(to, 0L) <= 0 ? ULongRange.Companion.getEMPTY() : new ULongRange($this$until_u2deb3DHEI, ULong.m216constructorimpl(to - ULong.m216constructorimpl(1 & 4294967295L)), null);
    }

    /* renamed from: until-5PvTz6A  reason: not valid java name */
    public static final UIntRange m1313until5PvTz6A(short $this$until_u2d5PvTz6A, short to) {
        return Intrinsics.compare(to & UShort.MAX_VALUE, 0) <= 0 ? UIntRange.Companion.getEMPTY() : new UIntRange(UInt.m138constructorimpl($this$until_u2d5PvTz6A & UShort.MAX_VALUE), UInt.m138constructorimpl(UInt.m138constructorimpl(65535 & to) - 1), null);
    }
    ...
    public static final int m1297coerceInWZ9TVnA(int $this$coerceIn_u2dWZ9TVnA, int minimumValue, int maximumValue) {
    ...
    public static final long m1299coerceInsambcqE(long $this$coerceIn_u2dsambcqE, long minimumValue, long maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) ULong.m261toStringimpl(maximumValue)) + " is less than minimum " + ((Object) ULong.m261toStringimpl(minimumValue)) + '.');
    }

    /* renamed from: coerceIn-b33U2AM  reason: not valid java name */
    public static final byte m1298coerceInb33U2AM(byte $this$coerceIn_u2db33U2AM, byte minimumValue, byte maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UByte.m105toStringimpl(maximumValue)) + " is less than minimum " + ((Object) UByte.m105toStringimpl(minimumValue)) + '.');
    }

    /* renamed from: coerceIn-VKSA0NQ  reason: not valid java name */
    public static final short m1296coerceInVKSA0NQ(short $this$coerceIn_u2dVKSA0NQ, short minimumValue, short maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UShort.m365toStringimpl(maximumValue)) + " is less than minimum " + ((Object) UShort.m365toStringimpl(minimumValue)) + '.');
    }
    ...
    public static final int m1300coerceInwuiCnnA(int $this$coerceIn_u2dwuiCnnA, ClosedRange<UInt> range) {
        ...
        if (range instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt.coerceIn(UInt.m132boximpl($this$coerceIn_u2dwuiCnnA), (ClosedFloatingPointRange<UInt>) range)).m189unboximpl();
        }
        if (range.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
        }
        return UnsignedKt.uintCompare($this$coerceIn_u2dwuiCnnA, range.getStart().m189unboximpl()) < 0 ? range.getStart().m189unboximpl() : UnsignedKt.uintCompare($this$coerceIn_u2dwuiCnnA, range.getEndInclusive().m189unboximpl()) > 0 ? range.getEndInclusive().m189unboximpl() : $this$coerceIn_u2dwuiCnnA;
    }
    ...
    public static final long m1295coerceInJPwROB0(long $this$coerceIn_u2dJPwROB0, ClosedRange<ULong> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt.coerceIn(ULong.m210boximpl($this$coerceIn_u2dJPwROB0), (ClosedFloatingPointRange<ULong>) range)).m267unboximpl();
        }
        if (range.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
        }
        return UnsignedKt.ulongCompare($this$coerceIn_u2dJPwROB0, range.getStart().m267unboximpl()) < 0 ? range.getStart().m267unboximpl() : UnsignedKt.ulongCompare($this$coerceIn_u2dJPwROB0, range.getEndInclusive().m267unboximpl()) > 0 ? range.getEndInclusive().m267unboximpl() : $this$coerceIn_u2dJPwROB0;
    }
}
